...
- [~] **Split `db.ts` monolith** — extracted shared models/types/sanitizers/checksum/import normalization into `src/utils/db/models.ts`; remaining split of sync/cloud/import-export modules still pending.
